...
public class WpService
{
    ...
    public boolean sendWhatsAppMessage(String name, String email, String phoneNumber, String destination) {
        try
        {
            // Construct the URL
            ...
            String jsonPayload = String.format(
                    "{"
                            ...
                            + "\"to\": \"%s\","
                            + "\"type\": \"text\","
                            + "\"text\": {\"body\": \"Hello! You have a new form submission.\\nName: %s\\nEmail: %s\\nPhone: %s\\nDestination: %s\"}"
                            + "}",
                    RECIPIENT_PHONE, name, email, phoneNumber,destination
            );
